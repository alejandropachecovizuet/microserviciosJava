package com.interware.curso.employeeMicroservice;
...
@SpringBootTest(classes = EmployeeMicroserviceApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
